...
parasails.registerUtility('isValidEmailAddress', function (supposedEmailAddress) {
  ...
  _.each(chunksOnEitherSideOfPeriods, function (chunk) {
    ...
    var notAllowedInChunksNextToDotsRX = new RegExp(/[^a-z0-9\-]/);
    if (chunk.match(notAllowedInChunksNextToDotsRX)) {
      return false;
    }
  });
